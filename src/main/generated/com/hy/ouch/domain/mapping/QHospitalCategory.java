...
public class QHospitalCategory extends EntityPathBase<HospitalCategory> {
	...
	public QHospitalCategory(Class<? extends HospitalCategory> type, PathMetadata metadata, PathInits inits) {
		...
		this.hospitalCategoryPk = inits.isInitialized("hospitalCategoryPk") ?
			new com.hy.ouch.domain.mapping.compositeKey.QHospitalCategoryPk(forProperty("hospitalCategoryPk")) : null;
		this.medicalCategory = inits.isInitialized("medicalCategory") ?
			new com.hy.ouch.domain.QMedicalCategory(forProperty("medicalCategory")) : null;
	}
