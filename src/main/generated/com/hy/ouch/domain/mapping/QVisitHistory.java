...
public class QVisitHistory extends EntityPathBase<VisitHistory> {
    ...
    public QVisitHistory(Class<? extends VisitHistory> type, PathMetadata metadata, PathInits inits) {
        ...
        this.summary = inits.isInitialized("summary") ? new com.hy.ouch.domain.QSummary(forProperty("summary"), inits.get("summary")) : null;
        this.user = inits.isInitialized("user") ? new com.hy.ouch.domain.QUser(forProperty("user"), inits.get("user")) : null;
    }
